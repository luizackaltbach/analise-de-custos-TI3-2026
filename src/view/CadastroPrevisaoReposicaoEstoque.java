...
public class CadastroPrevisaoReposicaoEstoque extends javax.swing.JInternalFrame {
    

    /**
     * Creates new form CadastroPrevisaoReposicaoEstoque
     */
    ...
    try {
        ...
        competenciaData.setFormatterFactory(
                new javax.swing.text.DefaultFormatterFactory(mascara)
        );
        competenciaData.setValue(null);

    } catch (java.text.ParseException ex) {
        throw new IllegalStateException("Erro ao configurar a máscara.", ex);
    }


    configurarSpinnerDecimal(quantidadeSpinner);
    configurarSpinnerDecimal(custorepSpinner);
    configurarSpinnerDecimal(outrosgastSpinner);
    configurarSpinnerDecimal(gastostotaisSpinner);
}

private void configurarSpinnerDecimal(javax.swing.JSpinner spinner) {
    spinner.setModel(
    ...
    spinner.setEditor(
        new javax.swing.JSpinner.NumberEditor(spinner, "0.00")
    );
}
